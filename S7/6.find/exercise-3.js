...
const nameCucushumushu = aliens.find(alien => alien.name === 'Cucushumushu');

const mutationPorompompero = mutations.find(mutation => mutation.name === 'Porompompero');

if( nameCucushumushu && mutationPorompompero) {
    nameCucushumushu.mutation = mutationPorompompero
};
